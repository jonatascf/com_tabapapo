...
<div class="taba-square">
	...
	<div class="taba-content">
		...
		<form action="<?php echo JRoute::_('index.php?option=com_tabapapo&view=tabapapo&layout=tabapapochat'); ?>"
		...
		<div class="row">
				   ...
				   <div class="col-md-2">
						 ...
						 <div class="row">
							...
							<div class="col-md-4">
							   ...
							   echo '<span class="taba-hover icon-cube" title="Dice" onclick="show_info('."'".'divdice'."'".');"></span>'; }?>             
		  ...
		  <div class="col-md-4">
			...
			<input type="hidden" id="owner" name="owner" value="<?php echo $this->item->created_by; ?>"/>
			
			<input type="hidden" id="description" value="<?php echo $this->item->description; ?>">

			<input type="hidden" id="show_info" value="0">
			 
			<input type="hidden" id="show_private" value="<?php if ($this->item->params->get('show_private')) { echo '1';} else { echo '0'; }?>">

			<input type="hidden" id="users_limit" value="<?php echo $users_limit; ?>">
