...
class TabaPapoViewTabaPapo extends JViewLegacy
{
	...
	function display($tpl = null)
	{
		...
		// Set the submenu
		//TabaPapoHelper::addSubmenu('tabapapoadd');
	...
	protected function addToolBar() {
		...
		{
			JToolBarHelper::addNew('tabapapoadd.add', 'JTOOLBAR_NEW');
		}
		if ($this->canDo->get('core.edit')) 
		{
			JToolBarHelper::editList('tabapapoadd.edit', 'JTOOLBAR_EDIT');
		}
		if ($this->canDo->get('core.delete')) 
		{
			JToolBarHelper::deleteList('', 'tabapapoadd.delete', 'JTOOLBAR_DELETE');
		}
	...
	protected function addToolBar_dashboard() {
		
		$title = JText::_('COM_TABAPAPO_DASHBOARD');
		JToolBarHelper::title($title, 'tabapapo');
