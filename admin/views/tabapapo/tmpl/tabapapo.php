...
<!----							<th scope="col" class="w-10 d-none d-md-table-cell">
            		...
            		<tbody>
						...
						foreach ($this->items as $i => $item) :
							...
							$canDelete  = $user->authorise('core.delete',     'com_tabapapo.category.' . $item->catid);
                     ...
                     $link = JRoute::_('index.php?option=com_tabapapo&task=tabapapoadd.edit&id=' . $item->id); ?>
            			<tr>
								...
								<td class="text-center">
									<?php echo HTMLHelper::_('jgrid.published', $item->published, $i, 'tabapapoadd.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
								</td>
