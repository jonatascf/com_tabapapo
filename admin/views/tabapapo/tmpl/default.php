...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<p><a class="btn btn-info btn-lg" href="index.php?option=com_config&view=component&component=com_tabapapo" role="button"><i class="icon-options"></i><?php echo ' '.Text::_('COM_TABAPAPO_CONFIGURATION');?></a></p>
		</div>
		<div class="col-md-6">
